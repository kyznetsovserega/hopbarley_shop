    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, help_text='Цена товара на момент оформления заказа (snapshot)', max_digits=10, verbose_name='Цена на момент покупки')),
